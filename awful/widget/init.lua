...
require("awful.widget.battery")
require("awful.widget.cpu")
require("awful.widget.uptime")
require("awful.widget.kernel")
require("awful.widget.user")
require("awful.widget.hostname")
require("awful.widget.ram")
